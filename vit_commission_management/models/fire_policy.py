...
class FirePolicy(models.Model):
    _inherit = 'fire.policy'

    commission_line_ids = fields.One2many('commission.line', 'fire_policy_id', compute='_compute_commission_lines',
                                          store=True)
