...
class FirePolicy(models.Model):
    ...
    name = fields.Char(string="Fire Policy ",readonly=True)
    ...
    parent_id = fields.Many2one('fire.policy', string="Parent Policy")
    child_ids = fields.One2many('fire.policy', 'parent_id', string="Sub Policies")
