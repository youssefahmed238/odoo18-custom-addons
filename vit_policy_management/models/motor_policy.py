...
class MotorPolicy(models.Model):
    ...
    category = fields.Many2one(
        'policy.category',
        string="Category",
        default=lambda self: self._default_motor_category(), )

    motor_sequences = fields.Char(string="Sequences", readonly=True)
    ...
    car_chassis_number = fields.Char(string="Car Chassis Number")
    car_engine_number = fields.Char(string="Car Engine Number")
    car_registration_number = fields.Char(string="Car Registration Number")
    ...
    def _default_motor_category(self):
